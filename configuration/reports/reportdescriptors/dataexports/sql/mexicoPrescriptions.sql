...
set @codedDiagnosis = concept_from_mapping('org.openmrs.module.emrapi', 'Coded Diagnosis');
set @nonCodedDiagnosis = concept_from_mapping('org.openmrs.module.emrapi', 'Non-Coded Diagnosis');
...
insert into temp_encounters (encounter_id, patient_id, encounter_date, has_prescriptions)
...
select o.obs_id, o.encounter_id, o.concept_id, o.value_coded, o.value_drug, o.value_text
from obs o
...
select * from temp_encounters where has_prescriptions = true;
